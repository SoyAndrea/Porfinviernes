...
# serie de graficos
graficos <- create_graph_series() |> 
  add_graph_to_graph_series(grafico1) |> 
  add_graph_to_graph_series(grafico2) |> 
  add_graph_to_graph_series(grafico3) |> 
  add_graph_to_graph_series(grafico4) |> 
  add_graph_to_graph_series(grafico5) |> 
  add_graph_to_graph_series(grafico6) |> 
  add_graph_to_graph_series(grafico7)

# Render
render_graph_from_graph_series(graficos, 1)
render_graph_from_graph_series(graficos, 2)
render_graph_from_graph_series(graficos, 3)
render_graph_from_graph_series(graficos, 4)
render_graph_from_graph_series(graficos, 5)
render_graph_from_graph_series(graficos, 6)
render_graph_from_graph_series(graficos, 7)
